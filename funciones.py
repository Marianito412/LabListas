...
def decodificarAreaYTipo(pCodigo):
    ...
    area=listaTipos[listaArea.index(pCodigo[3])+1]
    return f"El material bibliográfico es {tipo} del área {area}"
...
def decodificarDetalle(pCodigo):
    ...
    fila=pCodigo[10:12]
    columna=pCodigo[12:]
    return f"“El material bibliográfico está al lado {lado}, en la fila {fila} columna {columna}."
